const socialProfiles = [
  {
    id: "instagram",
    href: "https://www.instagram.com/bal_vidyalaya_sheragada/",
    label: "Instagram",
  },
  {
    id: "facebook",
    href: "https://www.facebook.com/T2TSKILLFOUNDATION",
    label: "Facebook",
  },
  {
    id: "youtube",
    href: "https://www.youtube.com/@CSCBALVIDYALAYASheragada",
    label: "YouTube",
  },
] as const;
...
type SocialLinksProps = {
  className?: string;
  variant?: "default" | "topbar" | "footer";
};

export function SocialLinks({ className = "", variant = "default" }: SocialLinksProps) {
  return (
    <div className={`social-links social-links--${variant}${className ? ` ${className}` : ""}`}>
