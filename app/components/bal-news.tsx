...
const news: NewsItem[] = [
  ...
  },
  {
    ...
    category: "Event",
    date: "15 August",
    title: "Independence Day cultural programme — costumes, stories and the flag",
    excerpt: "On 15 August, children dressed as characters from Indian epics for a cultural programme that celebrated Independence Day with colour, music and pride.",
    story: "Independence Day at Bal Vidyalaya opened with a cultural programme. Learners appeared as Rama, Ravana, Hanuman, Krishna and friends, standing before a banner that read Technology Enabled Playful Learning. The classroom became a stage: foam mats, tricolour garlands, and a story every child could join.",
    tags: ["Independence Day", "Cultural programme"],
    image: activity("WhatsApp Image 2026-09-03 at 4.42.09 PM.jpeg"),
    alt: "Children in mythological costumes for the Independence Day cultural programme",
  },
  {
    id: "teachers-day",
    category: "Event",
  ...
  },
  {
    ...
    image: activity("WhatsApp Image 2026-09-03 at 4.54.41 PM (1).jpeg"),
