...
communities.</p><p>We create sustainable self-employment and wage-employment opportunities for candidates, including Persons with Disabilities.</p><div className="about-highlights"><div><b>2019</b><span>Established</span></div><div><b>80%</b><span>Employment transition goal</span></div><div><b>Odisha</b><span>Community rooted</span></div></div></div></section><section className="section about-intro-video" aria-label="T2T Skill Foundation introduction video"><div className="about-intro-video-inner"><p className="eyebrow">Our story in motion</p><blockquote className="about-intro-video-quote"><p>Where learning becomes livelihood — and every trained hand opens a door to dignity, independence, and hope.</p></blockquote><figure className="about-intro-video-frame"><video className="about-intro-video-player" controls playsInline preload="metadata" poster="/about/WhatsApp Image 2026-09-03 at 4.55.14 PM (1).jpeg"><source src="/VID-20260909-WA0005.mp4" type="video/mp4" />Your browser does not support this video.</video><figcaption>T2T Skill Foundation · Skill Development Centre, Sheragada</figcaption></figure></div></section></>}
